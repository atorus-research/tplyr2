...
Count layers can display each statistic in its own column per treatment group
-- a layout Tplyr v1 could not produce. The `stat_columns` setting takes a
named list of format strings; each entry becomes a separate result column
(e.g. a distinct-subject "n (%)" column beside an event-count "E" column
under every arm):
