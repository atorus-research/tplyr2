...
- [`is_tplyr_spec()`](https://atorus-research.github.io/tplyr2/reference/is_tplyr_spec.md)
...
- [`is_tplyr_layer()`](https://atorus-research.github.io/tplyr2/reference/is_tplyr_layer.md)
...
- [`is_pop_data()`](https://atorus-research.github.io/tplyr2/reference/is_pop_data.md)
...
- [`tplyr_adae`](https://atorus-research.github.io/tplyr2/reference/tplyr_adae.md)
  : Adverse events analysis dataset
- [`tplyr_adlb`](https://atorus-research.github.io/tplyr2/reference/tplyr_adlb.md)
  : Laboratory data analysis dataset
- [`tplyr_adsl`](https://atorus-research.github.io/tplyr2/reference/tplyr_adsl.md)
